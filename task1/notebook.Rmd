...
mtext(glue("Skewness: {skewness(data_source$Age)}\nKurtosis: {kurtosis(data_source$Age)}"), side=3, adj=1, padj=2)
...
### Projection Pursuit
```{r}
animate_xy(data=data_source[, c(3,5,6,7,8,10,12)], grand_tour(d=2))
```
